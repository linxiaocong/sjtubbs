...
public class BBSFetchr {
	...
	public static ArrayList<Topic> getTopTen() {
	...
	public static String getTopicList(String boardUrl, ArrayList<Topic> topicList) {
		String nextUrl = null;
		try {
	...
	public static String getReplyList(String topicUrl, ArrayList<Reply> replyList) {
		String nextUrl = null;
		try {
	...
	static public ArrayList<Section> getSectionList() {
	...
	static private ArrayList<Board> getBoards(String sectionUrl) {
		return parseBoards(sectionUrl);
	}

	static private ArrayList<Board> parseBoards(String url) {
